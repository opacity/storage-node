...
// 2019-05-06 12:32:36.0281251 -0400 EDT m=+0.167027001
        ...
        "/api/v1/metadata/putMetadataKeyHere": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "your metadata key which is 64-char hex string created deterministically from your account handle or private key",
                        "name": "metadataKey",
                        "in": "path",
                        "required": true
                    }
        ...
        "routes.UploadFileReq": {
            ...
            "properties": {
                ...
                "signature": {
                    ...
                    "maxLength": 130,
                    "minLength": 130,
                    "example": "a 130 character string created when you signed the request with your private key or account handle"
                },
                "uploadFile": {
                    "type": "object",

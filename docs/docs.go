...
// 2021-09-29 11:48:31.3248449 +0300 EEST m=+0.083189501
...
var doc = `{
    ...
    "definitions": {
        ...
        "routes.metadataMultipleV2KeyObject": {
            "type": "object",
            "required": [
                "metadataV2Keys",
                "timestamp"
            ...
            "properties": {
                "metadataV2Keys": {
                    ...
                    "example": [
                        "public keys for the metadataV2 encoded to base64url"
                    ]
                },
                "timestamp": {
                    "type": "integer"
        ...
        "routes.metadataMultipleV2KeyReq": {
            ...
            "properties": {
                "metadataMultipleV2KeyObject": {
                    "type": "object",
                    "$ref": "#/definitions/routes.metadataMultipleV2KeyObject"
                },
                "publicKey": {
                    "type": "string",
                    "maxLength": 66,

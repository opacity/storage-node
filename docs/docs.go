...
// 2019-05-30 17:45:50.8227182 -0400 EDT m=+0.155998001
    ...
    "paths": {
        ...
        "/api/v1/metadata/create": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "get or create metadata object",
                        "name": "getOrCreateMetadataReq",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/routes.getOrCreateMetadataReq"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "routes.getOrCreateMetadataReq": {
            ...
            "properties": {
                ...
                "requestBody": {
                    "type": "string",
                    "example": "should produce routes.getOrCreateMetadataObject, see description for example"
                },
                "signature": {
                    "description": "signature without 0x prefix is broken into\nR: sig[0:63]\nS: sig[64:127]",
                    "type": "string",
